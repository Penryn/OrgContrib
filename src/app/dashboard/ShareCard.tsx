...
export function ShareCard({ org, year, userLogin, totals, summary, ranking, onClose }: ShareCardProps) {
  ...
  const handleSaveImage = async () => {
    ...
    setSaving(true);
    try {
      // Hide the close and save buttons temporarily
      const closeBtn = cardRef.current.querySelector(".close-button") as HTMLElement;
      const actionBar = cardRef.current.closest(".share-card-wrapper")?.querySelector(".action-bar") as HTMLElement;
        ...
        >
          ...
          <div className="relative p-8">
            ...
            {ranking && ranking.rank > 0 ? (
              <div className="mt-6 rounded-xl bg-gradient-to-r from-amber-500/20 to-orange-500/20 p-4 backdrop-blur-sm ring-1 ring-amber-500/30">
